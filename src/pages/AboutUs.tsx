...
const CAPABILITIES = [
  {
    ...
    tags: ['Demand Forecasting', 'Resource Optimization', 'Constraint Management'],
  ...
  },
  {
    ...
    tags: ['Performance Analytics', 'Self-Learning Systems', 'Predictive Insights'],
...
const DIFFERENTIATORS = [
  { icon: Brain, title: 'AI-native architecture', description: 'Not rule-based automation' },
  { icon: Layers, title: 'End-to-end platforms', description: 'Covering planning, execution, and analytics' },
  { icon: Activity, title: 'Real-time decision-making', description: 'Powered by live data' },
  { icon: RefreshCw, title: 'Self-correcting systems', description: 'That learn from actual outcomes' },
  { icon: ShieldCheck, title: 'Enterprise-grade security', description: 'And control' },
  { icon: Rocket, title: 'Mission-critical reliability', description: 'Built for 24/7 operations' },
];

const COMMITMENTS = [
  { icon: Shield, title: 'Reliability', description: 'In mission-critical environments' },
  { icon: ShieldCheck, title: 'Security', description: 'Aligned with enterprise standards' },
  { icon: Eye, title: 'Transparency', description: 'Through real-time visibility and reporting' },
  { icon: Rocket, title: 'Scalability', description: 'To support growth across teams, locations, and regions' },
];

// ── Visual components — crafted product mockups ──────────────────────────────
function CapabilityVisual({ kind }: { kind: 'forecast' | 'tracking' | 'analytics' }) {
  if (kind === 'forecast') {
    ...
    return (
      <div className="relative h-full min-h-[340px] rounded-[24px] bg-gradient-to-br from-[#eff6ff] via-white to-[#e8f0f8] border border-[#e8f0f8] overflow-hidden p-6 sm:p-8">
        ...
        <div className="absolute top-5 left-5 rounded-xl bg-white px-3 py-2 shadow-[0_8px_24px_-8px_rgba(15,45,82,0.25)] border border-[#e8f0f8] flex items-center gap-2">
          ...
          <div>
            <p className="text-[9px] text-[#6B6A7C] uppercase tracking-wide leading-none">Accuracy</p>
            <p className="text-[13px] font-semibold text-[#0f2d52] leading-tight">94.2%</p>
          </div>
        </div>
        ...
        <div className="relative mt-20 rounded-[16px] bg-white border border-[#e8f0f8] p-5 shadow-[0_12px_32px_-12px_rgba(15,45,82,0.18)]">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-[15px] font-semibold text-[#0f2d52]">+12% vs last week</p>
            </div>
            <div className="flex items-center gap-1 rounded-full bg-[#e8f0f8] px-2 py-1">
              <TrendingUp className="w-3 h-3 text-[#0066cc]" />
              <span className="text-[10px] font-medium text-[#0066cc]">Up trend</span>
            </div>
          </div>
  ...
  if (kind === 'tracking') {
    return (
      <div className="relative h-full min-h-[340px] rounded-[24px] bg-gradient-to-br from-[#0f2d52] via-[#1a3d6b] to-[#2a5a8f] overflow-hidden p-6 sm:p-8">
        ...
        {/* Route line */}
        <svg viewBox="0 0 320 200" className="absolute inset-0 w-full h-full px-6 pt-20">
          <defs>
        ...
        <div className="absolute top-5 left-5 right-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-[11px] font-semibold text-white leading-tight">Truck 024 · Live</p>
            <p className="text-[10px] text-[#c8d7ea]">ETA 14:32 · On schedule</p>
          </div>
        ...
        <div className="absolute bottom-5 right-5 rounded-xl bg-white px-3 py-2 shadow-xl flex items-center gap-2">
          ...
          <div>
            <p className="text-[9px] text-[#6B6A7C] uppercase leading-none">Station #42</p>
            <p className="text-[11px] font-semibold text-[#0f2d52] leading-tight">Depot Alpha</p>
          </div>
        </div>
    ...
    <div className="relative h-full min-h-[340px] rounded-[24px] bg-gradient-to-br from-white via-[#f7f9fc] to-[#e8f0f8] border border-[#e8f0f8] overflow-hidden p-6 sm:p-8">
      ...
      <div className="relative grid grid-cols-3 gap-2 mb-4">
        {[
          ...
          <div key={k.label} className="rounded-xl bg-white border border-[#e8f0f8] p-2.5 shadow-sm">
            <div className="flex items-center gap-1.5 mb-1">
              <k.icon className="w-3 h-3 text-[#0066cc]" />
              <p className="text-[9px] text-[#6B6A7C] uppercase tracking-wide">{k.label}</p>
            </div>
            <p className="text-[15px] font-bold text-[#0f2d52] leading-none">{k.value}</p>
          </div>
        ))}
      </div>
      ...
      <div className="relative rounded-2xl bg-white border border-[#e8f0f8] p-4 shadow-[0_12px_32px_-12px_rgba(15,45,82,0.18)] mb-3">
        <div className="flex items-center justify-between mb-2">
          <p className="text-[11px] font-semibold text-[#0f2d52]">Learning curve</p>
      ...
      <section className="relative pt-[112px] sm:pt-[130px] lg:pt-[150px] pb-20 sm:pb-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0f2d52] via-[#1a3d6b] to-[#2a5a8f] overflow-hidden">
        ...
        <div className="relative max-w-[900px] mx-auto text-center">
          ...
          <p className="text-[15px] sm:text-[17px] leading-[28px] text-[#c8d7ea] max-w-[640px] mx-auto mb-8">
            We are a technology-driven company focused on building intelligent, AI-powered
            platforms that help businesses plan, execute, and optimize their operations with
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-[15px] sm:text-[16px] leading-[26px] text-[#3B394E] max-w-[640px] mx-auto">
                We design and develop enterprise-grade AI systems that bring together data,
                automation, and intelligence into a single, unified platform.
              </p>
            </div>
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {cap.tags.map((t) => (
                          ...
                          >
                            <Check className="w-3 h-3 text-[#0066cc]" strokeWidth={3} />
                            {t}
                          </span>
                        ))}
                      </div>
        ...
        <FadeInView>
          <div className="relative max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[15px] sm:text-[16px] leading-[26px] text-[#3B394E] max-w-[640px] mx-auto">
                Built on a foundation of intelligence, practicality, and continuous evolution.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-5 lg:gap-6">
              {CORE_PRINCIPLES.map((p, i) => (
                ...
                >
                  ...
                  <h3 className="text-[20px] font-semibold text-[#0f2d52] mb-3">{p.title}</h3>
                  <p className="text-[14px] leading-[22px] text-[#3B394E]">{p.description}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-[15px] sm:text-[16px] leading-[26px] text-[#3B394E] mb-6">
                  Many organizations still rely on manual tools, disconnected systems, and static
                  planning methods.{' '}
                  <span className="font-semibold text-[#0f2d52]">We exist to change that.</span>
                </p>
                ...
                <div className="relative rounded-[20px] bg-gradient-to-br from-[#0f2d52] to-[#1a3d6b] p-6 sm:p-7 shadow-xl overflow-hidden">
                  ...
                  <p className="relative text-[14px] sm:text-[15px] leading-[24px] text-white">
                    ...
                    spreadsheet-driven processes to intelligent, AI-driven operations that are
                    scalable, transparent, and future-ready.
                  </p>
                </div>
              </div>
            </div>
              ...
              {DIFFERENTIATORS.map((d, i) => (
                ...
                >
                  ...
                  <div className="relative flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-[#0f2d52] mb-1">{d.title}</h3>
                      <p className="text-[13px] leading-[20px] text-[#3B394E]">{d.description}</p>
                    </div>
                  </div>
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="relative">
                ...
                <div className="relative rounded-[24px] overflow-hidden border border-[#e8f0f8] shadow-[0_30px_60px_-20px_rgba(15,45,82,0.25)]">
                  <img src={reports} alt="Operational analytics" className="w-full h-auto" />
                </div>
                {/* Floating badge */}
                <div className="absolute -top-3 -right-3 rounded-2xl bg-[#0f2d52] text-white shadow-lg px-4 py-3 flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-[9px] uppercase tracking-wide text-[#c8d7ea]">Visibility</p>
                    <p className="text-[12px] font-semibold leading-none">End-to-end</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-[15px] sm:text-[16px] leading-[26px] text-[#3B394E] mb-6">
                  We envision a future where operational decisions are data-driven, automated, and
                  continuously optimized — enabling businesses to operate{' '}
                ...
                <div className="relative rounded-[16px] bg-[#e8f0f8] border-l-4 border-[#0066cc] px-6 py-5">
                  <p className="text-[14px] leading-[22px] text-[#0f2d52]">
                    Our goal is to become a trusted partner for organizations looking to adopt AI
                    responsibly and effectively across their core operations.
                  </p>
                </div>
              </div>
            </div>
        ...
        <FadeInView>
          <div className="relative max-w-[820px] mx-auto text-center">
            ...
            <p className="text-[14px] sm:text-[15px] leading-[24px] text-[#c8d7ea] max-w-[620px] mx-auto mb-8">
              Whether you are starting your AI journey or scaling an existing operation, we are
              here to help you design, deploy, and evolve intelligent systems that deliver
              measurable value.
            </p>
